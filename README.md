#In the file, "question1.js" the code helps the user determine where in the list of (A-E) you fall in, determined by your score. To run the #code all you need to do is type in your console "node question1.js"
